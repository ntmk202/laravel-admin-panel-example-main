        ...
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <th scope="col" class="relative px-4 py-2">Edit</th>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 whitespace-nowrap"><a href="{{url('edit-flowers/'.$key)}}" class="m-2 p-2 bg-yellow-400 rounded">Edit</a></td>
